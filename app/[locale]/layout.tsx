...
const leagueGothic = localFont({
  src: [{ path: "../../public/fonts/LeagueGothic-Regular.ttf", weight: "400", style: "normal" }],
...
// Async child server component to fetch messages
async function LayoutContent({ children, locale }: { children: ReactNode; locale: string }) {
  ...
  return (
    <NextIntlClientProvider messages={messages}>
      <div className={`${cairo.variable} ${openSans.variable} ${leagueGothic.variable}`} dir={dir}>
